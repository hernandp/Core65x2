#[cfg(test)]
    use mem;
    use cpu;
    use super::{FLAG_SIGN,FLAG_BRK,FLAG_CARRY,FLAG_DEC,FLAG_INTR,FLAG_OF,FLAG_ZERO};
    ...
    fn test_lda() { 
        ...
        */
        ...
        sys_cpu.exec();
        assert_cpu_state(&sys_cpu, &CpuState {
            a: Some(ZP_TEST_BYTE), x: None, y: None, sp:None,
            pc: Some(0x0004), clk: Some(5), sr: Some(0)
        });
        ...
        sys_cpu.exec();
        assert_cpu_state(&sys_cpu, &CpuState {
             a: Some(ZP_TEST_BYTE_NEG), x: Some(0x82), y: None, sp:None,
            pc: Some(0x0006), clk: Some(9), sr: Some(FLAG_SIGN)
        });
        ...
        sys_cpu.exec();
        assert_cpu_state(&sys_cpu, &CpuState {
             a: Some(TEST_BYTE), x: None, y: None, sp:None,
            pc: Some(0x0009), clk: Some(13), sr: Some(FLAG_SIGN)
        });
        ...
        sys_cpu.exec();
        assert_cpu_state(&sys_cpu, &CpuState {
             a: Some(TEST_BYTE), x: Some(2), y: None, sp:None,
            pc: Some(0x000C), clk: Some(17), sr: Some(FLAG_SIGN)
        });
        ...
        sys_cpu.exec();
        assert_cpu_state(&sys_cpu, &CpuState {
             a: Some(TEST_BYTE), x: None, y: Some(4), sp:None,
            pc: Some(0x000F), clk: Some(21), sr: Some(FLAG_SIGN)
        });
        ...
        sys_cpu.exec();
        assert_cpu_state(&sys_cpu, &CpuState {
             a: Some(TEST_BYTE), x: Some(0x1c), y: None, sp:None,
            pc: Some(0x0011), clk: Some(27), sr: Some(FLAG_SIGN)
        });
        ...
        sys_cpu.exec();
        assert_cpu_state(&sys_cpu, &CpuState {
             a: Some(TEST_BYTE), x: None, y: Some(0x7a), sp:None,
            pc: Some(0x0013), clk: Some(32), sr: Some(FLAG_SIGN)
        });
    }
